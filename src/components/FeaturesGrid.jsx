...
const FeaturesGrid = () => {
  return (
    <section
      id="features-grid"
      className="features-grid-section animate-on-scroll fade-up"
    >
      <div className="container">
        {featureGroups.map((group, groupIdx) => (
          <div key={group.label} className="fg-group">
            ...
            <div className="fg-grid animate-on-scroll fade-up">
              {group.features.map((f, idx) => {
                ...
                return (
                  <div
                    id="featuresgrid-div-1"
                    key={f.id}
                    className={`fg-card-wrapper animate-on-scroll fade-up ${staggerClass}`}
                  >
